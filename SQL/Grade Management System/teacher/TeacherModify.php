...
if($_SERVER['REQUEST_METHOD']  == 'POST'){
	...
	echo '<p>教工号：&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="text" name="teacher_id" value = '.$_SESSION['teacher_id'].' readOnly="true">';
    echo '<p>当前密码：&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="password" name="oldpwd">';
	echo '<p>新密码：&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="password" name="newpwd1">';
	echo '<p>确认新密码：&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="password" name="newpwd2">';
