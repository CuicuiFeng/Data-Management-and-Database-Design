CREATE DATABASE  IF NOT EXISTS `assign_temp` /*!40100 DEFAULT CHARACTER SET gbk */;
USE `assign_temp`;
-- MySQL dump 10.13  Distrib 5.6.17, for Win64 (x86_64)
--
-- Host: localhost    Database: assigntemp
-- ------------------------------------------------------
...
INSERT INTO `course` VALUES ('C02','数据库原理',51,3,'春'),('C03','操作系统',51,2,'秋'),('C04','JAVA 程序设计',40,2,'秋'),('C05','计算机组成原理',30,2,'春');
...
-- Dump completed on 2017-03-30 14:46:25
